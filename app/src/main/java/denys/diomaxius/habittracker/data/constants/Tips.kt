...
object Tips {
    ...
    val firstSlidePoint = listOf<String>(
        "Behavior Automation: ",
        "Incremental Change: ",
        "Personal Growth: "
    )

    val firstSlideText = listOf<String>(
        "Good habits help automate routine actions, saving mental energy for more important decisions.",
        "Small daily steps accumulate over time and lead to significant improvements.",
        "Habits structure your day, boost productivity, and enhance overall quality of life."
    )

    val secondSlidePoint = listOf<String>(
        "Cues: ",
        "Planning: ",
    ...
    val secondSlideText = listOf<String>(
        "Place reminders or visual signals in your environment (e.g., a sticky note on the fridge for healthy eating).",
        "Set a specific time and place to perform your new habit.",
        "Pair the habit with something you enjoy (for example, listen to your favorite music while exercising).",
        "Link the new habit with a rewarding action (such as having a cup of tea after a short meditation).",
        "Start with small, manageable steps—think of the “2-minute rule,” where you reduce the habit to its simplest form.",
        "Remove obstacles and create conditions that make it as easy as possible to complete the habit.",
        "Small rewards after completing the habit can help reinforce positive behavior.",
        "Use visual indicators (like a calendar with marked days) to celebrate your progress and stay motivated."
    )

    val thirdSlidePoint = listOf<String>(
        "Start Small: ",
    ...
    val thirdSlideText = listOf<String>(
        "Focus on changes that are easy to integrate into your daily routine. Small wins build the foundation for long-term success.",
        "Pair a new habit with a well-established routine (e.g., after your morning coffee, spend two minutes meditating).",
        "Define clear rituals by deciding when and where you will perform the habit until it becomes a natural part of your day.",
        "Keep a record of your successes and reflect on what helps or hinders your progress. Visual progress tracking can boost motivation.",
        "Change takes time. Even if progress seems slow, remember that consistency will eventually lead to meaningful results.",
    )

    val fourthSlidePoint = listOf<String>(
        "Efficiency and Energy: ",
        "Personal Development: ",
        "Health and Wellbeing: "
    )

    val fourthSlideText = listOf<String>(
        "Automating positive behaviors frees up mental resources for more significant challenges.",
        "Continuous improvement through small steps helps you achieve bigger goals.",
        "Regular positive habits (like exercise, balanced nutrition, or meditation) contribute to both physical and mental health.",
    )
}
